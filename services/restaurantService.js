...
export async function fetchRestaurantsData(
  ...
  const url = `https://api.yelp.com/v3/businesses/search?latitude=${latitude}&longitude=${longitude}&term=restaurant&radius=${radiusInMeters}&categories=&sort_by=best_match&limit=20`;
